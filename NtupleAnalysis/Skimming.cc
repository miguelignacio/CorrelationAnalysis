...
int main(int argc, char *argv[])
{
    ...
    TFile *tempfile = TFile::Open((TString)argv[2]);
    ...
    TFile *newfile = new TFile("13def_v2_Small.root","recreate");
	...
	for(Long64_t ievent = 0; ievent < nevents ; ievent++){     
	  ...
	  //fprintf(stderr,"%s: %d: Skimming Event %llu / %llu",__FILE__, __LINE__, ievent,nevents);
